...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dockWidget_2.setWindowTitle(_translate("MainWindow", "Search and replace"))
        self.label_2.setText(_translate("MainWindow", "Search text"))
        self.label.setText(_translate("MainWindow", "Search column"))
        self.toolButton_4.setText(_translate("MainWindow", "Replace all"))
        self.label_3.setText(_translate("MainWindow", "Replace text"))
        self.comboBox.setItemText(0, _translate("MainWindow", "All columns"))
        self.label_4.setText(_translate("MainWindow", "Search type"))
        self.comboBox_2.setItemText(0, _translate("MainWindow", "Perfect matching"))
        self.comboBox_2.setItemText(1, _translate("MainWindow", "Partial Match"))
